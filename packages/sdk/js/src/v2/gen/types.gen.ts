...
/**
 * Server configuration for opendoc serve and web commands
 */
...
export type Config = {
  ...
  server?: ServerConfig
  /**
   * Command configuration, see https://opendoc.creativdev.org/docs/commands
   */
  command?: {
    [key: string]: {
      template: string
  ...
  /**
   * Agent configuration, see https://opendoc.creativdev.org/docs/agent
   */
  agent?: {
    plan?: AgentConfig
    build?: AgentConfig
