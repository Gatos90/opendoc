...
export namespace Permission {
  ...
  // Modified for non-interactive API mode - no blocking, auto-allow
  export async function ask(input: {
    ...
    log.info("ask (auto-allowed, non-interactive mode)", {
      sessionID: input.sessionID,
      messageID: input.messageID,
      toolCallID: input.callID,
      pattern: input.pattern,
    })
    // Auto-allow in non-interactive mode - no blocking
    // Actual access control is handled by PermissionNext ruleset
    return
  }
