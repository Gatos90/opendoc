...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/opendoc.git")).toEqual({ owner: "sst", repo: "opendoc" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/opendoc")).toEqual({ owner: "sst", repo: "opendoc" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/opendoc.git")).toEqual({ owner: "sst", repo: "opendoc" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/opendoc")).toEqual({ owner: "sst", repo: "opendoc" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/opendoc.git")).toEqual({ owner: "sst", repo: "opendoc" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/opendoc")).toEqual({ owner: "sst", repo: "opendoc" })
})
