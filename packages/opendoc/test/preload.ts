...
const dir = path.join(os.tmpdir(), "opendoc-test-data-" + process.pid)
...
process.env["OPENDOC_TEST_HOME"] = testHome
...
const cacheDir = path.join(dir, "cache", "opendoc")
...
process.env["OPENDOC_DISABLE_MODELS_FETCH"] = "true"
