...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders OPENDOC_CALLER", () => {
    process.env["OPENDOC_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode OPENDOC_CALLER", () => {
    process.env["OPENDOC_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown OPENDOC_CALLER", () => {
    process.env["OPENDOC_CALLER"] = "unknown"
