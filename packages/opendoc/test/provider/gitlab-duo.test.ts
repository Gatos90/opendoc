...
const mockPlugin = () => ({})
mock.module("opendoc-copilot-auth", () => ({ default: mockPlugin }))
mock.module("opendoc-anthropic-auth", () => ({ default: mockPlugin }))
mock.module("@gitlab/opendoc-gitlab-auth", () => ({ default: mockPlugin }))
